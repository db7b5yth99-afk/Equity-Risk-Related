...
def run_tsang_sim(price_df, decision_date, total_days=60, window=30,
    ...
    for t in range(total_days):
        data = get_price(price_df, decision_date, window)
        ...
        next_decision = decision_date + pd.Timedelta(days=1)
